  ...
  <div class="content-wrapper">
   ...
   <section class="content">
      ...
      <table class="table table-bordered">
          <tr>
              <td class="text-left"><h1>List of Analyst</h1></td>
              <?php
                $strButton="";              
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody >
                    ...
                    <?php
                        ...
                        $sql="select * from dbo.V_TIR_UserAccount WHERE USERTYPE='Credit Analyst'";
...
//                                          &nbsp;&nbsp;&nbsp;Delete &nbsp;&nbsp;&nbsp;
                                    ...
                                    $strDisplay.="<td>
                                        ...
                                        <a href='AnalystHandled.php?ID=$row[BDM_USERNAME]' class='btn medium bg-blue tooltip-button' data-placement='top' title='Edit'>
                                          &nbsp;&nbsp;&nbsp;New Tagging &nbsp;&nbsp;&nbsp;
                                        </a>
                                    </td>";  
