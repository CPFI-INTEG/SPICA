<?php
    ...
    if(isset($_GET['DisApprove'])){
      ...
      $sqlUpdateRejected="update tip.partial_Balance set remarks='',remarks1='',ispoke=0 where id=".$id;
                     ...
                     <div class='box-body'>
                        ...
                        <div class='col-xs-6'>
                                  ...
                                  <div class='form-group'>
                                    ...
                                    <div class='col-sm-5'>
                                      <input type='text' class='form-control'  disabled value='<?php echo substr($Field21,2,6) ?>'>
                                    </div>
                                  </div>
                        </div>
                      </div>
        ...
        <div class="col-xs-12">
            <div class="box box-alert">
              <div class="box-footer">
                  <a href='approvedPartial.php'><input type=button class='btn medium bg-blue' value='Back'></a> 
              </div>
