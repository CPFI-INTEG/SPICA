                  ...
                  <tbody >
                    ...
                    <?php
                        ...
                        if(isset($_GET['Info'])){
                          ...
                          if($Info=='Total'){ // to know pag ang INFO VARIABLE AY "TOTAL"
                                if($UserType=="Sales Finance Assistant"){// to know if this is SALES finance
                                  $sql="select DIM4_Cd,dim5_Desc,ID,division,target_Company,bp_parent_Cd,bp_parent_name,budget_desc,transaction_Amount,dim4_Cd ,isstatus,ispoke,IsStatusSubmitted from tip.Vw_BDMUserTagging where reporting_period in (select max(reporting_period) from [TIP].[Vw_BDMUserTagging] where reporting_year in (select max(reporting_year) from [TIP].[Vw_BDMUserTagging] ) )";
                                }elseif($UserType=="Credit and Collection Supervisor"){ // credit and collection to!
                                  $sql="select DIM4_Cd,dim5_Desc,ID,division,target_Company,bp_parent_Cd,bp_parent_name,budget_desc,transaction_Amount,dim4_Cd ,isstatus,ispoke,IsStatusSubmitted from tip.Vw_BDMUserTagging where isstatuscomplete='Completed' and id in (select dataid from tip.TIR_ShouldBE where hasvalidation='YES') and reporting_period in (select max(reporting_period) from [TIP].[Vw_BDMUserTagging] where reporting_year in (select max(reporting_year) from [TIP].[Vw_BDMUserTagging] ) )";
                                }elseif($UserType=="District Business Development Manager"){ 
                                  $sql="select DIM4_Cd,dim5_Desc,ID,division,target_Company,bp_parent_Cd,bp_parent_name,budget_desc,transaction_Amount,dim4_Cd ,isstatus,ispoke,IsStatusSubmitted from tip.Vw_BDMUserTagging where reporting_period in (select max(reporting_period) from [TIP].[Vw_BDMUserTagging] where reporting_year in (select max(reporting_year) from [TIP].[Vw_BDMUserTagging] ) )";
                                }elseif($UserType=="Credit Analyst"){ // credit and collection to!
                                  $sql="select DIM4_Cd,dim5_Desc,ID,division,target_Company,bp_parent_Cd,bp_parent_name,budget_desc,transaction_Amount,dim4_Cd ,isstatus,ispoke,IsStatusSubmitted from tip.Vw_BDMUserTagging where isstatuscomplete='Completed' and id in (select dataid from tip.TIR_ShouldBE where hasvalidation='YES') and reporting_period in (select max(reporting_period) from [TIP].[Vw_BDMUserTagging] where reporting_year in (select max(reporting_year) from [TIP].[Vw_BDMUserTagging] ) )";
                                }else{ 
                                    $sql="select DIM4_Cd,dim5_Desc,ID,division,target_Company,bp_parent_Cd,bp_parent_name,budget_desc,transaction_Amount,dim4_Cd ,isstatus,ispoke,IsStatusSubmitted from tip.Vw_BDMUserTagging where bdm_username='".$parentCode."' and company_Cd in (". $BusinessUnit .")  and reporting_period in (select max(reporting_period) from [TIP].[Vw_BDMUserTagging] where reporting_year in (select max(reporting_year) from [TIP].[Vw_BDMUserTagging] ) )";
                                }
                                
                          //ACCOMPLISHED
                          }elseif($Info=='Accomplished'){ // to know pag ang INFO VARIABLE AY "TOTAL"
                                if($UserType=="Sales Finance Assistant"){// to know if this is SALES finance
                                    $sql="select DIM4_Cd,dim5_Desc,ID,division,target_Company,bp_parent_Cd,bp_parent_name,budget_desc,transaction_Amount,dim4_Cd ,isstatus,ispoke,IsStatusSubmitted from tip.Vw_BDMUserTagging where reporting_period in (select max(reporting_period) from [TIP].[Vw_BDMUserTagging] where reporting_year in (select max(reporting_year) from [TIP].[Vw_BDMUserTagging] ) ) and isstatus='Accomplished'";
                                }elseif($UserType=="Credit and Collection Supervisor"){ // credit and collection to!
                                    $sql="select DIM4_Cd,dim5_Desc,ID,division,target_Company,bp_parent_Cd,bp_parent_name,budget_desc,transaction_Amount,dim4_Cd ,isstatus,ispoke,IsStatusSubmitted from tip.Vw_BDMUserTagging where IsStatusSubmitted in('Approved','Disapproved') and reporting_period in (select max(reporting_period) from [TIP].[Vw_BDMUserTagging] where reporting_year in (select max(reporting_year) from [TIP].[Vw_BDMUserTagging] ) )";
                                }elseif($UserType=="District Business Development Manager"){ 
                                  $sql="select DIM4_Cd,dim5_Desc,ID,division,target_Company,bp_parent_Cd,bp_parent_name,budget_desc,transaction_Amount,dim4_Cd ,isstatus,ispoke,IsStatusSubmitted from tip.Vw_BDMUserTagging where reporting_period in (select max(reporting_period) from [TIP].[Vw_BDMUserTagging] where reporting_year in (select max(reporting_year) from [TIP].[Vw_BDMUserTagging] ) ) and isstatus='Accomplished'";                                  
                                }elseif($UserType=="Credit Analyst"){ // credit and collection to!
                                  $sql="select DIM4_Cd,dim5_Desc,ID,division,target_Company,bp_parent_Cd,bp_parent_name,budget_desc,transaction_Amount,dim4_Cd ,isstatus,ispoke,IsStatusSubmitted from tip.Vw_BDMUserTagging where IsStatusSubmitted in('Approved','Disapproved') and reporting_period in (select max(reporting_period) from [TIP].[Vw_BDMUserTagging] where reporting_year in (select max(reporting_year) from [TIP].[Vw_BDMUserTagging] ) )";
                          ...
                          //DRAFT
                                ...
                                if($UserType=="Sales Finance Assistant"){// to know if this is SALES finance
                                  $sql="select DIM4_Cd,dim5_Desc,ID,division,target_Company,bp_parent_Cd,bp_parent_name,budget_desc,transaction_Amount,dim4_Cd ,isstatus,ispoke,IsStatusSubmitted from tip.Vw_BDMUserTagging where  reporting_period in (select max(reporting_period) from [TIP].[Vw_BDMUserTagging] where reporting_year in (select max(reporting_year) from [TIP].[Vw_BDMUserTagging] ) ) and isstatus='draft'";
                                }elseif($UserType=="Credit and Collection Supervisor"){ // credit and collection to!
                                  $sql="select DIM4_Cd,dim5_Desc,ID,division,target_Company,bp_parent_Cd,bp_parent_name,budget_desc,transaction_Amount,dim4_Cd ,isstatus,ispoke,IsStatusSubmitted from tip.Vw_BDMUserTagging where  reporting_period =''";                                  
                                }elseif($UserType=="District Business Development Manager"){ 
                                  $sql="select DIM4_Cd,dim5_Desc,ID,division,target_Company,bp_parent_Cd,bp_parent_name,budget_desc,transaction_Amount,dim4_Cd ,isstatus,ispoke,IsStatusSubmitted from tip.Vw_BDMUserTagging where  reporting_period in (select max(reporting_period) from [TIP].[Vw_BDMUserTagging] where reporting_year in (select max(reporting_year) from [TIP].[Vw_BDMUserTagging] ) ) and isstatus='draft'";
                                }elseif($UserType=="Credit Analyst"){ // credit and collection to!
                                  $sql="select DIM4_Cd,dim5_Desc,ID,division,target_Company,bp_parent_Cd,bp_parent_name,budget_desc,transaction_Amount,dim4_Cd ,isstatus,ispoke,IsStatusSubmitted from tip.Vw_BDMUserTagging where  reporting_period =''";                                                                    
                        ...
                        //  echo $UserType;
                                if($UserType=="Sales Finance Assistant"){// to know if this is SALES finance
                                 // ECHO "KAMOTE";
                                    $sql="select DIM4_Cd,dim5_Desc,ID,division,target_Company,bp_parent_Cd,bp_parent_name,budget_desc,transaction_Amount,dim4_Cd ,isstatus,ispoke,IsStatusSubmitted from tip.Vw_BDMUserTagging where  reporting_period in (select max(reporting_period) from [TIP].[Vw_BDMUserTagging] where reporting_year in (select max(reporting_year) from [TIP].[Vw_BDMUserTagging] ) ) and isstatus='Pending'";
                                }elseif($UserType=="Credit and Collection Supervisor"){ // credit and collection to!
                                  $sql=("select DIM4_Cd,dim5_Desc,ID,division,target_Company,bp_parent_Cd,bp_parent_name,budget_desc,transaction_Amount,dim4_Cd ,isstatus,ispoke,IsStatusSubmitted from tip.Vw_BDMUserTagging where IsStatusSubmitted ='Submitted' and id in (select dataid from tip.TIR_ShouldBE where hasvalidation='YES') and reporting_period in (select max(reporting_period) from [TIP].[Vw_BDMUserTagging] where reporting_year in (select max(reporting_year) from [TIP].[Vw_BDMUserTagging] ) )");
                                }elseif($UserType=="District Business Development Manager"){ 
                                  $sql="select DIM4_Cd,dim5_Desc,ID,division,target_Company,bp_parent_Cd,bp_parent_name,budget_desc,transaction_Amount,dim4_Cd ,isstatus,ispoke,IsStatusSubmitted from tip.Vw_BDMUserTagging where  reporting_period in (select max(reporting_period) from [TIP].[Vw_BDMUserTagging] where reporting_year in (select max(reporting_year) from [TIP].[Vw_BDMUserTagging] ) ) and isstatus='Pending'";
                                }elseif($UserType=="Credit Analyst"){ // credit and collection to!
                                  $sql=("select DIM4_Cd,dim5_Desc,ID,division,target_Company,bp_parent_Cd,bp_parent_name,budget_desc,transaction_Amount,dim4_Cd ,isstatus,ispoke,IsStatusSubmitted from tip.Vw_BDMUserTagging where IsStatusSubmitted ='Submitted' and id in (select dataid from tip.TIR_ShouldBE where hasvalidation='YES') and reporting_period in (select max(reporting_period) from [TIP].[Vw_BDMUserTagging] where reporting_year in (select max(reporting_year) from [TIP].[Vw_BDMUserTagging] ) )");
                                  ...
                                  $strDisplay.="<td>$row[isstatus]</td>"; 
                                    ...
                                    if($UserType=="Business Development Manager"){// to know if this IF BDM
                                          if($Info=="Total" or $Info=="Accomplished"){
                                              $strDisplay.="<td>  
                                                 <a href='ViewSalesFinance.php?ID=$row[ID]&MoreInfoID=1' class='btn medium bg-blue tooltip-button' data-placement='top' title='Edit'>
                                                    &nbsp;&nbsp;&nbsp;View &nbsp;&nbsp;&nbsp;
                                                  </a>
                                              </td>";
                                          }else{                                    
                                            $strDisplay.="<td>
                                              <a href='DataFill.php?MoreInfoID=$row[ID]' class='btn medium bg-green tooltip-button' data-placement='top' title='Edit'>
                                                  &nbsp;&nbsp;&nbsp;Fill-in&nbsp;&nbsp;&nbsp;
                                              </a>                                   
                                            </td>";
                                          }
