<?php
    ...
    if(isset($_GET['ID'])){
      ...
      while($row=sqlsrv_fetch_array($stmt,SQLSRV_FETCH_ASSOC)){
        ...
        $Field15=$row['remarks'];
        $Field16=$row['attachment'];
        $Field17=$row['dim5_Desc'];
        $Field18=$row['division'];
    ...
    if(isset($_GET['ID'])){
      $id=$_GET['ID'];
      include("model/dbcon.php");
      $sqlShould="select id,dataid,Amount,year,type,correctexpense,expense,correctdivision,divsion,remarks,promoid from tip.TIR_ShouldBE  where dataid=" .$id. "";
   //   echo $sqlShould;
      ...
      <div class="row">
        ...
        <div class="col-xs-12">
            <div class="box-footer">
              <a href='Approved.php'><button class="btn medium bg-blue">&nbsp;&nbsp;&nbsp;Back&nbsp;&nbsp;&nbsp;</button></a>
            </div>
          </div>
