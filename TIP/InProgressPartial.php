                  ...
                  <tbody >
                    ...
                    <?php
                        ...
                        elseif($UserType=="Credit and Collection Supervisor"){ // credit and collection to!
                          ...
                          $sql="select dim5_Desc_Division,Company_CD,[PARENT_NAME] as parent_name ,DIM4_Cd,DISTRICT,ischeck,isstatus,isstatussubmitted,isstatuscomplete,ID,ispoke from tip.V_PARTIAL_BALANCE  where bdm_username='".$parentCode."' and IsStatusSubmitted='Pending'  AND  dim5_Cd in (". $BusinessUnit .") and ischeck='Checked'";
