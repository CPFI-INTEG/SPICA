  ...
  <div class="content-wrapper">
   ...
   <section class="content">
      ...
      <table class="table table-bordered">
          <tr>
              <td class="text-left"><h1>List of BP</h1></td>
              <?php
                $strButton="";              
                $strButton.="<td><br><a href='BPTaggingEntry.php'><button type='button' class='btn btn-block btn-primary btn-lg'>New Tagging</button></a></td>";
                //echo $strButton;
              ?>
              ...
              <div class="box-body">
                <table id="example1" class="table table-bordered table-striped">
                  <thead>
                    <tr>
                      <?php
                          $strHeader="<th>BP Code</th>";
                          $strHeader.="<th>BP Name</th>";
                  ...
                  <tbody >
                    ...
                    <?php
                        ...
                        $sql="sELECT BUSINESS_PARTNER_SID,BUSINESS_PARTNER_cD,BUSINESS_PARTNER_NAME,PARENT_CD,PARENT_NAME,c_customer_type_Cd,c_customer_type_desc FROM TIP.BUSINESS_PARTNER";
                        ...
                        $strDisplay="";
                         while($row=sqlsrv_fetch_array($stmt,SQLSRV_FETCH_ASSOC)){
                            $strDisplay.="<tr>";
                                   ...
                                   $strDisplay.="<td>$row[BUSINESS_PARTNER_cD]</td>";
                                   $strDisplay.="<td>$row[BUSINESS_PARTNER_NAME]</td>";
                                   $strDisplay.="<td>$row[PARENT_CD]</td>";
                                   $strDisplay.="<td>$row[PARENT_NAME]</td>";
                                   $strDisplay.="<td>$row[c_customer_type_desc] ( $row[c_customer_type_Cd] )</td>";
...
//                                          &nbsp;&nbsp;&nbsp;Delete &nbsp;&nbsp;&nbsp;
                                    ...
                                    $strDisplay.="<td>
                                        ...
                                        <a href='BPTaggingEntry.php?ID=$row[BUSINESS_PARTNER_SID]' class='btn medium bg-blue tooltip-button' data-placement='top' title='Edit'>
                                          &nbsp;&nbsp;&nbsp;Edit &nbsp;&nbsp;&nbsp;
                                        </a>
