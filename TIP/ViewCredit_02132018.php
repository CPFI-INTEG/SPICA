        ...
        <div class="col-xs-12">
            <div class="box box-info">
              ...
              <div class="box-footer">
                ...
                <button type='button'  class='btn medium bg-green' data-toggle='modal' data-target='#exampleModal' data-whatever='<?php echo $Field6 ?>'>Re-class</button>
                <!--<a href='function/UpdateDisApprove.php?DisID=<?php echo $_GET['ID']; ?>'><input type=button  class="btn medium bg-red" value="Disapprove"/></a>-->
