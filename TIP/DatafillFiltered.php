    ...
    $strAmountAlloted="";
     ...
     $TUNA="";
      ...
      if($ID<>""){
          include("model/dbcon.php");
          //echo $ID;
          $sqlShould="select BucketType,id,dataid,year,type,correctexpense,expense,correctdivision,divsion,remarks,promoid from tip.TIR_ShouldBE  where dataid=" .$ID. "";
          ECHO $sqlShould;
      ...
      <div class="row">
        ...
        <div class="col-xs-12">
            <div class="box box-primary">
                ...
                <form class="form-horizontal" action='function/SaveShouldFiltered.php'    method='POST' onsubmit="return CheckRemarks()" >
                     ...
                     <div class='box-body'>
                        ...
                        <div class='col-xs-6'>
                            ...
                            <div class='form-group'>
                              ...
                              <div class='col-sm-4'>
                                <input type='text' class='form-control'  disabled value='<?php echo number_format($Field9)?>'>
                              </div>
  ...
  function CheckRemarks() {
   ...
   // alert(TafType.indexOf("CORP"));
    ...
    //  alert(TafType.indexOf("CORP"));
      ...
      var TotalBudget=parseInt(bMeat) + parseInt(bHunts) + parseInt(bSARDINES) + parseInt(bVita) + parseInt(bDairy) + parseInt(bRMB) + parseInt(bTuna);
      //alert(TotalBudget);
