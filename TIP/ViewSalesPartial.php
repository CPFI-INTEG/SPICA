<?php
    ...
    if(isset($_GET['Type'])){
      ...
      $sqlUpdateRejected="update tip.partial_Balance set remarks='' where id=".$id;
    ...
    if(isset($_GET['ID'])){
      $id=$_GET['ID'];
      include("model/dbcon.php");
      $sql="select attachment,[Partial Remarks] as PartialRemark, bp_type_Cd,cast(invoice_Date as nvarchar)  as invoice_Date,budget_desc,invoice_month,ID,dim5_desc_division,bp_code,business_partner_name,parent_name,parent_Cd,district,name,invoice,pr_number,cast(or_Date as nvarchar)  as or_Date,transaction_Amount,dim1_Desc,remarks,dim4_Cd,invoice_year,division,transaction_sid from tip.V_PARTIAL_BALANCE where id=" .$id. "";
                     ...
                     <div class='box-body'>
                        ...
                        <div class='col-xs-6'>
                                  ...
                                  <div class='form-group'>
                                    ...
                                    <div class='col-sm-5'>
                                      <input type='text' class='form-control'  disabled value='<?php echo substr($Field9,0,4) ?>'>
                                    </div>
                                  </div>
                        </div>
                      </div>
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                  <h4 class="modal-title" id="exampleModalLabel"> REASON FOR REJECTION </h4>
                </div>
                <div class="modal-body">
                      ...
                      <div class="box-body">
                          <div class="col-xs-12">
                              <div class="form-group">
                                  ...
                                  <textarea class="form-control" name="reject" id="reject"  rows="3" placeholder="Please indicate the reason ..."><?php if(isset($Field21)){ echo $Field21;} ?></textarea>
                              </div>

                               <div class="form-group">
                                <label > Attachment File :</label>
                                <input NAME="FileImg"  accept="image/*" type="file">
                                <input NAME="HoldIMG"  id="HoldIMG"   type="hidden"  value="<?php echo $Field22 ?>">
                 ...
                 <div class="box-footer">
                  ...
                  <?php
                     if(isset($_GET['Flag'])){
                        ...
                        echo "<a href='IndexPartial.php'><input type=button class='btn medium bg-red' value='Cancel'></a>    ";
                     }
                  ?>
                  <button type='button'  class='btn medium bg-red' data-toggle='modal' data-target='#exampleModal1'>Reject</button>
                  <input type='button'  class='btn medium bg-blue' data-toggle='modal' data-target='#exampleModal' data-whatever='<?php echo $Field22 ?>' value="View Attachment">
...
<script>
  $('#exampleModal').on('show.bs.modal', function (event) {
    ...
    if(recipient!=""){
      ...
      $("#image_from_url").attr('src','images/NoAttachment.png');  
    }
