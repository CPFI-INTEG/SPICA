  <?php
    ...
    //  echo $sql;
      ...
      while($row=sqlsrv_fetch_array($stmt,SQLSRV_FETCH_ASSOC)){
        ...
        $Field19=$row['RevisedAttachmentFile'];
                      ...
                      <div class="box-body">
                          <div class="col-xs-12">
                              <div class="form-group">
                                  ...
                                  <textarea class="form-control" name="reject" id="reject"  rows="3" placeholder="Please indicate the reason ..."><?php if(isset($Field15)){ echo $Field15;} ?></textarea>
                              </div>

                               <div class="form-group">
                                <label > Attachment File :</label>
                                <input NAME="FileImg"  accept="image/*" type="file" value="<?php echo $Field17 ?>">
                ...
                <div class="box-footer">
                  <?php
                    if(isset($_GET['MoreInfoID'])){ // if the source data is from DASHBOARD
                      echo "<a href='Index.php'><input type=button class='btn medium bg-red' value='Back'></a>    ";
                    }else{
                      echo "<input type='button'  class='btn medium bg-blue' data-toggle='modal' data-target='#exampleModal' data-whatever='<?php echo $Field18 ?>' value='View Attachment'>";
                      echo "<button type='button'  class='btn medium bg-red' data-toggle='modal' data-target='#exampleModal1'>Reject</button>";
                       if(isset($_GET['Flag'])){
