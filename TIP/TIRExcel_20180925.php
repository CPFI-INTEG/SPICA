...
$objPHPExcel->setActiveSheetIndex(0)
			...
			while($row=sqlsrv_fetch_array($stmt,SQLSRV_FETCH_ASSOC)){
				...
				//STATUS
				$objPHPExcel->getActiveSheet()->setCellValue ('Y'.$x,'=IF(AND(K'.$x.'="--",L'.$x.'="--",M'.$x.'="--",N'.$x.'="--",O'.$x.'="--",P'.$x.'="--"),"Pending",IF(OR(K'.$x.'="--",L'.$x.'="--",M'.$x.'="--",N'.$x.'="--",O'.$x.'="--",P'.$x.'="--",K'.$x.'="",L'.$x.'="",M'.$x.'="",N'.$x.'="",O'.$x.'="",P'.$x.'=""),"Draft",IF(OR(AND(AB'.$x.'="FALSE",AA'.$x.'=0),(AND(AB'.$x.'="TRUE",AA'.$x.'=I'.$x.'))),"Accomplished","Draft")))');
				...
				$objPHPExcel->getActiveSheet()->setCellValue ('AB'.$x,'=IFERROR(IF((SEARCH("CORP",K'.$x.'))<>0,"TRUE","FALSE"),"FALSE")');
