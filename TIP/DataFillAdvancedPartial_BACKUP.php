...
//                $StrCorrectExpense=$rowShould['correctexpense'];
  //              $StrExpense=$rowShould['expense'];
    ...
    if(isset($_GET['ID'])){
      ...
      $sql="select  status,bp_type_Cd,cast(invoice_Date as nvarchar)  as invoice_Date,budget_desc,invoice_month,ID,dim5_desc_division,bp_code,business_partner_name,parent_name,parent_Cd,district,name,invoice,pr_number,cast(or_Date as nvarchar)  as or_Date,transaction_Amount,dim1_Desc,remarks,dim4_Cd,invoice_year,division,transaction_sid from tip.V_PARTIAL_BALANCE where id=" .$id. "";
            ...
            <?php
              $strTab="<div class='nav-tabs-custom'>";
                $strTab.="<div class='tab-content'>";
                    ...
                    $CounterHolder='';
                    $sqlCount="select count(id) as counter from tip.V_PARTIAL_BALANCE where bdm_username='".$parentCode."' and IsStatusSubmitted='Pending' ";
                    ...
                    $sql=" select TOP 1 bp_type_Cd,cast(invoice_Date as nvarchar)  as invoice_Date,budget_desc,invoice_month,ID,dim5_desc_division,bp_code,business_partner_name,parent_name,parent_Cd,district,name,invoice,pr_number,cast(or_Date as nvarchar)  as or_Date,transaction_Amount,dim1_Desc,remarks,dim4_Cd,invoice_year,division,transaction_sid from tip.V_PARTIAL_BALANCE where  bdm_username='".$parentCode."' and IsStatusSubmitted='Pending'
                    UNION ALL select bp_type_Cd,cast(invoice_Date as nvarchar)  as invoice_Date,budget_desc,invoice_month,ID,dim5_desc_division,bp_code,business_partner_name,parent_name,parent_Cd,district,name,invoice,pr_number,cast(or_Date as nvarchar)  as or_Date,transaction_Amount,dim1_Desc,remarks,dim4_Cd,invoice_year,division,transaction_sid from tip.V_PARTIAL_BALANCE where  bdm_username='".$parentCode."' and IsStatusSubmitted='Pending'  ";
                    //and DATEPART(month, or_Date)=DATEPART(month, getdate())-1
...
//                                                $strTab.="<input type='text' class='form-control'  disabled value='".$Field11."'>";
                                            ...
                                            $strTab.="<div class='form-group'>";
                                              ...
                                              $strTab.="<div class='col-sm-5'>";
                                                $strTab.="<input type='text' class='form-control'  disabled value='".substr($Field9,0,4)."'>";
                                              $strTab.="</div>";
                                            $strTab.="</div>";
                    ...
                    <div class="col-xs-6">
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                  ...
                                  <input type="number" required class="form-control" id="StrYear" name="StrYear" onkeypress="return isNumber(event)" placeholder="Input Year"  maxlength="4" value="<?php echo $StrYear ?>">
                                </div>
                              </div>
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                   <textarea  class="form-control" rows="3" name="StrRemarks" id="StrRemarks" placeholder="Input Remarks"><?PHP echo $StrRemarks ?></textarea>
                                </div>
                              </div>
                    </div>
