...
$objPHPExcel->setActiveSheetIndex(0)
			...
			while($row=sqlsrv_fetch_array($stmt,SQLSRV_FETCH_ASSOC)){
				...
				//STATUS
				$objPHPExcel->getActiveSheet()->setCellValue ('Y'.$x,'=IF(AND(P'.$x.'="--",J'.$x.'="--",K'.$x.'="--",L'.$x.'="--",M'.$x.'="--",N'.$x.'="--",O'.$x.'="--"),"Pending",IF(OR(P'.$x.'="--",J'.$x.'="--",K'.$x.'="--",L'.$x.'="--",M'.$x.'="--",N'.$x.'="--",O'.$x.'="--",P'.$x.'="",J'.$x.'="",K'.$x.'="",L'.$x.'="",M'.$x.'="",N'.$x.'="",O'.$x.'=""),"Draft",IF(OR(AND(AB'.$x.'="FALSE",AA'.$x.'="0"),(AND(AB'.$x.'="TRUE",AA'.$x.'=CONCATENATE(F'.$x.',"")))),"Accomplished","Draft")))');
				...
				$objPHPExcel->getActiveSheet()->setCellValue ('AB'.$x,'=IFERROR(IF((SEARCH("CORP",J'.$x.'))<>0,"TRUE","FALSE"),"FALSE")');
